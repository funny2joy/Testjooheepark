...
public class Homework5 {
     /*숙제 5
         ...
         인덱스는 0 부터 시작한다.
         8번째, 10 번째, 12 번째, 16번째
         인덱스의 값들을 추출하여 출력하고
         추출한 값들을 모두 더한 값을 출력하시요.
     ...
     public static void main(String[] args) {
         ...
         System.out.println("몇 번째 항까지 살펴볼까요?");
         num = in.nextInt();
