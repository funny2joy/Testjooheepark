...
public class ChallengeClassfication {
    ...
    public static void main(String[] args) {
        ...
        for(i =0; i <len ; i++){
            if(i==0){
                ...
                // 단 증감부를 거치게 됨.
                continue; //올라가서 증감부로 감. continue가 없으면 if 문에서 빠져나와서 밑에 줄 실행.
            }

            //중복이 없으면
            for(j=0; j < i; j++){
                // 중복이 있다면 for 문 바로 빠져나옴
